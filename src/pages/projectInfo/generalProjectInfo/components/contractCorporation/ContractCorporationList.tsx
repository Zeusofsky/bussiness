...
import ContractCorporationPieChart from "./ContractCorporationPieChart";


interface ContractCorporationListProps {
    corporations: IContractCorporation;
}
const ContractCorporationList: FC<ContractCorporationListProps> = ({corporations}): ReactElement => {
        ...
        <Box sx={{height:330, minWidth:{xs:450,sm:500,md:420,lg:450,xl:475}, bgcolor:theme.palette.background.paper, borderRadius:2, boxShadow:4}} >
            ...
            >
                {corporations && corporations.E && 
                    <ContractCorporationPieChart corporationItems={corporations.E} title={'Engineering'}/>
                }    
                {corporations && corporations.P && 
                    <ContractCorporationPieChart corporationItems={corporations.P} title={'Procurement'}/>
                }
                {corporations && corporations.C && 
                    <ContractCorporationPieChart corporationItems={corporations.C} title={'Construction'}/>
                }
            </Box>
        </Box>
    )
...
export default ContractCorporationList;
